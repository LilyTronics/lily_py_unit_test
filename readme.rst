...
- `Project page on GitHub <https://github.com/LilyTronics/lily-py-unit-test>`_.
- `Package on PyPi <https://pypi.org/project/lily-unit-test>`_.
- `Documentation on Read the Docs <https://lily-py-unit-test.readthedocs.io>`_.
...
More examples and how to can be found in the `documentation on Read the Docs <https://lily-py-unit-test.readthedocs.io>`_.
